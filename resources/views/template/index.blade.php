                        ...
                        <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
                            <div class="carousel-inner">
                                @foreach($customers as $customer)
                                    <div class="carousel-item @if($customer->id ==21) active @endif">
                                        <div class="review_content">
                                            <img src="assets/images/team4.png" alt="">
                                            <p class="text-size-18">Lorem ipsum dolor sit amet, consectetur adipiscin elit, sed do eiusmod tempor incididunt ut labor et doloremagna aliquaquis.</p>
                                            <h4 class="mb-0">{{$customer->first_name}} {{$customer->last_name}} </h4>
                                            <span class="text-size-16">{{$customer->telephone}}</span>
                                        </div>
                                    </div>
